...
### Task 1: Add locale registry and source catalog
...
### Task 2: Wire `next-intl` into the App Router
...
### Task 3: Add temporary language selection
...
### Task 4: Persist user language preference
...
### Task 5: Add translation quality gates
...
### Task 6: Convert one complete workflow
