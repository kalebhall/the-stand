...
const notification = {
  ...
  title: 'Calling suggested',
  summary: 'Calling suggested: Bishop',
  details: { callingName: 'Bishop' },
  severity: 'info',
  targetUrl: '/callings/c-1',
  readAt: null,
...
describe('NotificationCenter', () => {
  ...
  it('loads unread notifications, expands details, and marks opened item read', async () => {
    ...
    await waitFor(() =>
      expect(fetchMock).toHaveBeenCalledWith('/api/w/ward-1/notifications/n-1', expect.objectContaining({ method: 'PATCH' }))
    );
